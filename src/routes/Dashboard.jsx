      ...
      <div className="App" id="Dashboard">
        <div className="container" style={{ width: '90%' }}>
          <div className="textCenter">
            <h2 className="textCenter mb-4 dash-welcome">
              Welcome, {user.name}
            </h2>
            ...
            >
              ...
              <button className="formFieldButton">Explore all shows</button>
            </div>
          </div>
        </div>
      </div>
